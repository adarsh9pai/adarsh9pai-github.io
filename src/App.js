        ...
        <Content>
          <QueueAnim delay={500} type='left' ease = 'easeInOutQuart'>
            ...
            <div key = {2}>
              ...
              <a href = "https://www.twitter.com/adarsh9pai" className = "social"><SiTwitter /></a>
              ...
              <a href = "mailto://adarsh9pai@gmail.com/" className = "social"><MdAlternateEmail /></a>
            </div>
            <div key = {3}>
              <br/><br/>
              <Text className = "IntroductionText">Currently living in the <mark style={{background: '#BE3A34'}}><a href = "https://en.wikipedia.org/wiki/San_Francisco_Bay_Area" style={{color: '#041E42'}}>San Francisco Bay Area</a></mark>.</Text>
            </div>
          </QueueAnim>
        </Content>
        <Footer style = {{textAlign : 'center'}}>
          <Text style={{color: '#696969'}}>© 2022</Text>
        </Footer>
      </Layout>
    )
  }
